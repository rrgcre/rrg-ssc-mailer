...
(function () {
  ...
  var css = ''
    ...
    + '#rrgnav .rrgbrandimg{max-width:100%;max-height:44px;object-fit:contain;display:block;background:#fff;border-radius:6px;padding:5px 8px;box-sizing:border-box;}'
