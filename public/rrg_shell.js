...
(function () {
  ...
  var css = ''
    ...
    + '#rrgnav a.it .navbadge{margin-left:auto;background:var(--red,#DA2B1F);color:#fff;font-size:11px;font-weight:800;min-width:20px;height:18px;line-height:18px;text-align:center;border-radius:9px;padding:0 6px;box-shadow:0 1px 3px rgba(0,0,0,.25);}'
