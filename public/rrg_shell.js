...
(function () {
  ...
  var css = ''
    ...
    + '#rrgtop .create{display:inline-flex;align-items:center;gap:6px;background:var(--red,#DA2B1F);color:#fff;border:1px solid var(--red,#DA2B1F);border-radius:9px;padding:8px 15px;font:inherit;font-size:13px;font-weight:600;cursor:pointer;text-decoration:none;white-space:nowrap;transition:filter .12s;}'
    + '#rrgtop .create:hover{filter:brightness(1.07);}'
