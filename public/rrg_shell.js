...
(function () {
  ...
  var css = ''
    ...
    + '#rrgtop .uav{width:26px;height:26px;border-radius:50%;background:var(--navbg,#233a68);color:#fff;font-weight:600;font-size:11px;display:flex;align-items:center;justify-content:center;cursor:pointer;border:none;padding:0;opacity:.9;}'
    + '#rrgtop .uav:hover{opacity:1;}'
