...
(function(){
  ...
  function injectCss(){ if(document.getElementById('rrgaiwork-css')) return; var st=document.createElement('style'); st.id='rrgaiwork-css';
    ...
    +'.rrgaiwbox.ai{border-top:2px solid #5a3d9e;}'                                          /* the small NetSuite AI twist */
    ...
    +'.rrgaiwbox.ai .rrgaiworb{border-top-color:#5a3d9e;}'
    +'.rrgaiwbox.ai .rrgaiworb:after{content:"\\2728";position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:15px;}'
    ...
    +'.rrgaiwtitle{font-weight:800;color:#20334f;font-size:15.5px;}'
    +'.rrgaiwmsg{color:#5f6a7d;font-size:12.5px;margin-top:6px;line-height:1.5;min-height:16px;}'
    +'.rrgaiwtimer{font-variant-numeric:tabular-nums;font-weight:800;font-size:20px;color:#20334f;margin-top:11px;}'
    +'.rrgaiwbox.ai .rrgaiwtimer{color:#5a3d9e;}'
    ...
    +'.rrgaiwbox.ai .rrgaiwbarfill{background:linear-gradient(90deg,#20334f,#5a3d9e);}'
    ...
    +'.rrgaicfhd{font-weight:800;color:#20334f;font-size:16px;}'
