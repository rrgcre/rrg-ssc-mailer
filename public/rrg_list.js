...
(function(){
  ...
  function injectStyle(){ if(document.getElementById(STYLE_ID)) return;
    var css=''
      +'.rl-bar{display:flex;align-items:center;flex-wrap:wrap;gap:10px 12px;margin:2px 0 14px;font:inherit}'
      ...
      +'th.rl-th{position:relative;cursor:pointer;user-select:none;white-space:nowrap;font-size:11px;letter-spacing:.02em;text-transform:uppercase;color:#8a94a6;font-weight:700;text-align:left;padding:11px 12px;border-bottom:1px solid #e9edf3;background:#fbfcfe}'
      ...
      +'.rl-wrap tbody td{padding:12px;border-bottom:1px solid #eef1f6;font-size:13.5px;color:#1f2a3d;vertical-align:middle}'
      ...
      +'.rl-compact .rl-wrap td{padding-top:6px !important;padding-bottom:6px !important;font-size:12.5px}'
