...
window.RRG_FORMS.seller = {
  ...
  categories:[
    ...
    { n:'3', title:'Financials', questions:[
      {type:'options', label:'Profitability', required:true, cols:2, options:['Profitable','Break-Even','Declining','Losing Money'], optMeta:[{w:2},{},{w:-1},{k:1,w:-3,n:"Losing money points to an asset sale \u2014 pivot to the buildout, FF&E and lease value, not a going-concern multiple."}], prompt:"Is the business making money right now?", hint:"The single most important answer on this call. Losing money points straight at an asset sale, not a going-concern sale."},
