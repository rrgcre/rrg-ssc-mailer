...
async function generateBov({ business, files, preparedBy, questionnaire, links, systemPrompt, sdeThreshold, assetSaleFloor }) {
  ...
  try {
    if (state.assetSale === true) {
      ...
      _f.execNarr = "Restaurant businesses are generally valued on their historical financial performance. When a concept is unprofitable, or only marginally so, there is little earnings-based value to capitalize, and the opportunity is best positioned as an asset sale — with worth concentrated in the leasehold improvements and equipment rather than the operation itself.\n\nFor ownership, the real value in these transactions is usually the exit from the lease. Assigning the lease to a qualified operator moves the remaining rent obligation — and often a personal guaranty — off the seller's books, while handing the buyer a built-out, licensed space in a desirable location at a fraction of the cost, and time, of building new. That exit is frequently worth far more to the seller than the price paid for the tangible assets themselves.\n\nBased on its current financial performance, RRG does not believe " + _biz + " supports a material going-concern value. Accordingly, the opportunity is best positioned as an asset sale, with value derived primarily from the FF&E, leasehold improvements, and any assignable leasehold rights and transferable licenses included in the transaction. The operation does not currently generate sufficient transferable cash flow to support an earnings-based valuation.";
      ...
      _f.gtmNarr = "Market the opportunity as an asset sale to qualified owner-operators and established area operators that can capitalize on the existing space, equipment, and leasehold improvements. The asking price should be anchored to the concluded asset value, with the target price and acceptable floor established once the FF&E valuation is complete.\n\nConsider offering the brand assets separately. The " + _biz + " name, recipes, trademarks, digital assets, social media accounts, and associated goodwill could be made available as an additional, negotiable component if buyer interest supports incremental value. Separating the brand from the hard assets provides flexibility and may help maximize total proceeds without inflating the value attributed to the physical assets.\n\nConduct a confidential, invitation-only marketing process rather than broadly advertising the opportunity. A controlled outreach strategy will protect employee, guest, and vendor relationships while targeting buyers most likely to recognize the value of the space and assets.";
      ...
      _f.earnNarr = "The bridge above normalizes the trailing-twelve-month results. On a normalized basis, the operation does not produce transferable cash flow sufficient to support a going-concern value — which is why RRG recommends an asset sale. It is included as supporting analysis, not as the basis of value.";
      ...
      _f.excluded = "Cash, receivables, payables and other working-capital items; any owned real estate; and personal or non-transferable items are excluded unless specifically negotiated into the sale.\n\nAlso excluded are the intangible and goodwill assets, which are not part of this transaction: the business name and branding, the menu and recipes, the website and domain, the telephone number(s), social media accounts and following, and customer and email lists, along with any trademarks, trade dress, or other intellectual property. Any of these may be made available as a separately negotiated component, but they are not included in the asset-sale value.";
